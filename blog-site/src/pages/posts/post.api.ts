...
export async function getPosts(): Promise<SinglePost[]> {
  return [
    ...
    },
    {
      ...
      author: "Jane Smith",
      content:
        "Markdown support in Astro makes it easy to create structured content...",
    ...
    },
    {
      ...
      content:
        "Vercel is an ideal platform for deploying static websites, and Astro fits perfectly...",
